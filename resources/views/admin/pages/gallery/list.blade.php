                ...
                <div class="card-header">
                  <h3 class="card-title">{{ $metadata['page_title'] }}</h3>
                    <div class="float-right">
                        <a href="{{ route('gallery.create') }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="New Records">
                ...
                <table class="table table-bordered">
                  ...
                  @if(isset($rows) && !$rows->isEmpty())
                    ...
                    <tr> 
                      ...
                      <td>
                        @if($res->type == 1)
                          <img src="{{ asset('storage/gallery_image/'.$res->media) }}" alt="{{ $res->title }}" width="50px" height="50px"></td>
                        @else
                          <a target="_blank" href="{{ $res->media }}" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="View">
                      ...
                      <td style="width: 130px;">
                        @can('gallery-edit') 
                          <a href="{{ route('gallery.edit',$res->id) }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                            <i class="fas fa-edit" aria-hidden="true"></i>
                          </a>
                        @endcan
                        @can('gallery-delete') 
                          <form id="deleteForm{{ $res->id }}" method="POST" action="{{ route('gallery.destroy', $res->id) }}" accept-charset="UTF-8" style="display:inline">
