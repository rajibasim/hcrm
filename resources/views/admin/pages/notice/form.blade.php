        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <form id="dataForm" method="post" action="{{ isset($details->id) && $details->id ? route('notice.update', $details->id) : route('notice.store') }}" autocomplete="off" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        <label>Notice</label>
                        <input type="file" class="form-control" placeholder="Banner Image" name="notice_file" value="" accept="application/pdf">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <!-- text input -->
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker3" placeholder="Post Date" name="post_date" value="{{ old('post_date', isset($details->post_date) && $details->post_date ? $details->post_date : '') }}" required="">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <!-- select -->
                ...
                <div class="card-footer">
                  ...
                  <a href="{{ route('notice.index') }}" class="btn btn-danger">Reset</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
