                ...
                <form method="get" action="" autocomplete="off" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <!-- select -->
                      <div class="form-group">
                        <input type="text" class="form-control datepicker3" placeholder="Post Date" name="post_date" value="{{ isset($serach_data['post_date']) && $serach_data['post_date'] ? $serach_data['post_date'] : '' }}">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <!-- select -->
                ...
                <div class="card-header">
                  <h3 class="card-title">{{ $metadata['page_title'] }}</h3>
                    <div class="float-right">
                        <a href="{{ route('notice.create') }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="New Records">
                ...
                <table class="table table-bordered">
                  ...
                  @if(isset($rows) && !$rows->isEmpty())
                    ...
                    <tr> 
                      ...
                      <td>
                        @if($res->notice_file)
                          <a target="_blank" href="{{ asset('storage/notice_file/'.$res->notice_file) }}" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="View">
                      ...
                      <td style="width: 130px;">
                        @can('notice-edit') 
                          <a href="{{ route('notice.edit',$res->id) }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                            <i class="fas fa-edit" aria-hidden="true"></i>
                          </a>
                        @endcan
                        @can('notice-delete') 
                          <form id="deleteForm{{ $res->id }}" method="POST" action="{{ route('notice.destroy', $res->id) }}" accept-charset="UTF-8" style="display:inline">
