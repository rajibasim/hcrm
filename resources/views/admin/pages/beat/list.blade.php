                ...
                <div class="card-header">
                  <h3 class="card-title">{{ $metadata['page_title'] }}</h3>
                    <div class="float-right">
                        <a href="{{ route('beat.create') }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="New Records">
                  ...
                  @if(isset($rows) && !$rows->isEmpty())
                    ...
                    <tr> 
                      ...
                      <td style="width: 100px;">
                        @can('beat_create')
                          <a href="{{ route('beat.edit',$res->id) }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                            <i class="fas fa-edit" aria-hidden="true"></i>
                          </a>
                        @endcan
                        @can('beat_delete')
                          <form id="deleteForm{{ $res->id }}" method="POST" action="{{ route('beat.destroy', $res->id) }}" accept-charset="UTF-8" style="display:inline">
