    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              @can('park_gate-create')
                <div class="card-header">
                  <h3 class="card-title">{{ $metadata['page_title'] }}</h3>
                    <div class="float-right">
                        <a href="{{ route('park_gate.create') }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="New Records">
                  ...
                  @if(isset($rows) && !$rows->isEmpty())
                    ...
                    <tr> 
                      ...
                      <td style="width: 100px;">
                        @can('park_gate-edit')
                          <a href="{{ route('park_gate.edit',$res->id) }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                            <i class="fas fa-edit" aria-hidden="true"></i>
                          </a>
                        @endcan
                        @can('park_gate-delete')
                          <form id="deleteForm{{ $res->id }}" method="POST" action="{{ route('park_gate.destroy', $res->id) }}" accept-charset="UTF-8" style="display:inline">
