        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
               <form id="dataForm" method="post" action="{{ isset($details->id) && $details->id ? route('park_gate.update', $details->id) : route('park_gate.store') }}" autocomplete="off" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Gate Name" name="name" value="{{ old('name', isset($details->name) && $details->name ? $details->name : '') }}" required="">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <!-- select -->
                ...
                <div class="card-footer">
                  ...
                  <a href="{{ route('park_gate.index') }}" class="btn btn-danger">Reset</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
