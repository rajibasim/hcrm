            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <form method="get" action="" autocomplete="off" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-10">
                      <input type="text" class="form-control" placeholder="Category" name="category" value="{{ isset($serach_data['category']) && $serach_data['category'] ? $serach_data['category'] : '' }}">
                    </div>
                    <div class="col-1">
                ...
                <div class="card-header">
                  <h3 class="card-title">{{ $metadata['page_title'] }}</h3>
                    <div class="float-right">
                        <a href="{{ route('category.create') }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="New Records">
                  ...
                  @if(isset($rows) && !$rows->isEmpty())
                    ...
                    <tr> 
                      ...
                      <td style="width: 100px;">
                        @can('category_create')
                          <a href="{{ route('category.edit',$res->id) }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                            <i class="fas fa-edit" aria-hidden="true"></i>
                          </a>
                        @endcan
                        @can('category_delete')
                          <form id="deleteForm{{ $res->id }}" method="POST" action="{{ route('category.destroy', $res->id) }}" accept-charset="UTF-8" style="display:inline">
