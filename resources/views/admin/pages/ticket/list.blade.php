                ...
                <form method="get" action="" autocomplete="off" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      <!-- select -->
                      <div class="form-group">
                        <input type="text" class="form-control datepicker3" placeholder="Booking Date" name="booking_date" value="{{ isset($serach_data['booking_date']) && $serach_data['booking_date'] ? $serach_data['booking_date'] : '' }}">
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <!-- select -->
                      <div class="form-group">
                        <input type="text" class="form-control" placeholder="Ticket No" name="ticket_no" value="{{ isset($serach_data['ticket_no']) && $serach_data['ticket_no'] ? $serach_data['ticket_no'] : '' }}">
                      </div>
                    </div>
                    <div class="col-1">
                ...
                <div class="card-header">
                  <h3 class="card-title">{{ $metadata['page_title'] }}</h3>
                    <div class="float-right">
                        <a href="{{ route('ticket.create') }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="New Records">
                  ...
                  @if(isset($rows) && !$rows->isEmpty())
                    ...
                    <tr> 
                      ...
                      <td style="width: 100px;">
                        <a href="{{ route('ticket.show',$res->id) }}" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="View">
                          <i class="fas fa-eye" aria-hidden="true"></i>
                        </a>
                        @can('ticket-edit')
                          <a href="{{ route('ticket.edit',$res->id) }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                            <i class="fas fa-edit" aria-hidden="true"></i>
                          </a>
                        @endcan
                        @can('ticket-delete')
                          <form id="deleteForm{{ $res->id }}" method="POST" action="{{ route('ticket.destroy', $res->id) }}" accept-charset="UTF-8" style="display:inline">
