                            ...
                            @if(isset($productReturn) && !$productReturn->isEmpty())
                              @foreach ( $productReturn as $rkey => $rres )
                                <tr class="addMore">
                                  ...
                                  <td width="15%">
                                    <input class="form-control sub_total" placeholder="Sub Total" type="text" name="sub_total[]" readonly="" value="{{ isset($rres->sub_total) && $rres->sub_total ? $rres->sub_total : '0.00' }}">
