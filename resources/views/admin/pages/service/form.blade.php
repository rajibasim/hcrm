        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <form id="dataForm" method="post" action="{{ isset($details->id) && $details->id ? route('service.update', $details->id) : route('service.store') }}" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="card-footer">
                  ...
                  <a href="{{ route('service.index') }}" class="btn btn-danger">Reset</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
