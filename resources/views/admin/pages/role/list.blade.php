              ...
              <div class="card-header">
                <h3 class="card-title">{{ $metadata['page_title'] }}</h3>
                  <div class="float-right">
                      <a href="{{ route('role.create') }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="New Records">
                  ...
                  @if(isset($rows) && !$rows->isEmpty())
                    ...
                    <tr> 
                      ...
                      <td style="width: 100px;">
                        <a href="{{ route('role.edit',$res->id) }}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                          <i class="fas fa-edit" aria-hidden="true"></i>
                        </a>
                        <form id="deleteForm{{ $res->id }}" method="POST" action="{{ route('role.destroy', $res->id) }}" accept-charset="UTF-8" style="display:inline">
