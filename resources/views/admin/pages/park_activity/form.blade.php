        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
               <form id="dataForm" method="post" action="{{ isset($details->id) && $details->id ? route('park_activity.update', $details->id) : route('park_activity.store') }}" autocomplete="off" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2" name="activity_id" id="activity_id" required="">
                          ...
                          @if($activity) && !$activity->isEmpty())
                            @foreach ( $activity as $key => $res )
                              <option value="{{ $res->id }}" data-price="{{ $res->price }}" data-duration="{{ $res->duration }}" {{ isset($details->activity_id) && $details->activity_id == $res->id ? 'selected' : '' }}>{{ $res->name }}</option>
                            @endforeach
                          @endif
                        </select>
                      </div>
                ...
                <div class="card-footer">
                  ...
                  <a href="{{ route('park_activity.index') }}" class="btn btn-danger">Reset</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
