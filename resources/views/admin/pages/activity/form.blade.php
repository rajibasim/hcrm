        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <form id="dataForm" method="post" action="{{ isset($details->id) && $details->id ? route('activity.update', $details->id) : route('activity.store') }}" autocomplete="off" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Duration" name="duration" value="{{ old('duration', isset($details->duration) && $details->duration ? $details->duration : '') }}" required="">
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <!-- select -->
                ...
                <div class="card-footer">
                  ...
                  <a href="{{ route('activity.index') }}" class="btn btn-danger">Reset</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
